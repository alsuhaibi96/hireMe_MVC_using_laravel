...
<div class="" style="margin-top: 120px ;margin-bottom: 90px">
    <div class="up-card my-0  my-sm-30 border-2  m-auto" data-v-e9c818fa="">
        <div class="text-center card col-5 m-auto" data-v-e9c818fa="">
            <h2 class="display-rebrand" data-v-e9c818fa="">Join as a client or freelancer</h2>
                    ...
                    <div class="row card-body p-5 " data-v-e9c818fa="">
                        ...
                        <div class="col-12 col-md-5 mt-10 card mx-2  p-3" data-v-e9c818fa="">
                            <div data-cy="button-box" class="up-button-box up-button-box-radio" data-v-e9c818fa="">
                                ...
                                <div class="up-illustration mt-2" data-v-e9c818fa=""><svg style="width: 50px;" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 145 130" aria-hidden="true" role="img"><path d="M125.657 123.228H57.062a1.55 1.55 0 01-1.553-1.555V8.328c0-.857.694-1.556 1.553-1.556h86.383c.857 0 1.556.698 1.556 1.556v95.436" fill="var(--illustration-color-2, #23264b)"></path><path d="M108.203 30.291H72.431a1.612 1.612 0 010-3.222h35.772a1.611 1.611 0 010 3.222zm20.481 22.017H72.603a1.61 1.61 0 110-3.221h56.081a1.61 1.61 0 110 3.221zm-9.783 39.794H72.603a1.612 1.612 0 010-3.223h46.299a1.611 1.611 0 11-.001 3.223zm9.783-26.532H72.603a1.61 1.61 0 110-3.221h56.081a1.61 1.61 0 110 3.221zm0 13.268H72.603a1.611 1.611 0 010-3.221h56.081a1.61 1.61 0 110 3.221z" fill="var(--illustration-color-5, #434894)"></path><polygon points="125.657,123.228 125.657,103.764 145,103.764" fill="var(--illustration-color-5, #2d3163)"></polygon><path d="M55.515 96.132v-38.19a3.597 3.597 0 013.598-3.596h12.751c4.575 0 8.661-2.723 9.095-7.278.5-5.227-3.597-8.688-8.72-8.688H53.424a8.747 8.747 0 00-5.891 2.271L34.754 51.467l-.217.199a8.71 8.71 0 01-6.059 2.438H2.628v42.027h52.887z" fill="var(--illustration-color-13, #e8f1e8)"></path><path d="M.809 98.674H29.34a1.62 1.62 0 001.623-1.616V53.236c0-.896-.728-1.621-1.623-1.621H.809a.809.809 0 00-.809.811v45.439c0 .444.36.809.809.809" fill="var(--illustration-color-1, #d5e0d5)"></path><path d="M24.839 60.703a2.5 2.5 0 11-5 0 2.5 2.5 0 115 0" fill="var(--white, #ffffff)"></path></svg></div>
            ...
            <div class="mt-30" data-v-e9c818fa="">
                <button type="submit" type="button" id="register_btn" disabled="disabled" class=" col-4 p-1 up-btn  rounded-3 m-auto  up-btn-primary width-md up-btn-block" data-v-e9c818fa="">Create Account</button>
                <p class="mb-0 mt-3 mb-2" data-v-e9c818fa="">Already have an account? <a href="/ab/account-security/login" data-v-e9c818fa="">
      Log In
    </a></p>
            </div>
        </div>
