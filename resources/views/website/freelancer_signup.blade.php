                      ...
                      <div class="card-body p-0">
                          <div class="row no-gutters">
                              <div class="col-lg-6">
                                  <div class="p-5">
                                      <div class="mb-3">
                                          <h3 class="h4 font-weight-bold text-theme">قم بتسجيل الحساب لايجاد العمل الذي تحب</h3>
                                      </div>
      
                                      <h6 class="h5 mb-0 mt-5">مرحباً بك   !</h6>
                                      <p class="text-muted mt-1 mb-3"> شكراً لتواجدك على منصتنا</p>
      
                                      <form action="{{ route('freelancer_create') }}" method="POST" enctype="multipart/form-data">
                                          @csrf
